...
By running \texttt{ltrace} whilst running the team obtained the library calls used during the computation phase.


\underline{Initial computation:}\\
\texttt{
    time
    {\color{red}
        \_\_cxa\_guard\_acquire
        localtime
        \_\_cxa\_guard\_release
    }
    strftime
    strftime
    strtol
...
\underline{Subsequent computations:}\\
\texttt{
    time
    strftime
    strftime
