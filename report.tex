...
%%% Examples of Article customisations
% These packages are optional, depending whether you want the features t	hey provide.
...
\input{investigate-circuit.tex}

\section{Serial Implementation}
\input{serial-implementation.tex}

\section{Parallel Implementation}
\input{parallel-implementation.tex}

\section[Analysis Parallelise]{Analysis Parallelise \footnote{read: paralysis (or ``paralylis'')} }
\input{plot-graphs.tex}
